...
class PlainRNNDataHandler:
    ...
    def reset_user_batch_data(self):
        ...
        for k, v in self.trainset.items(): self.users_with_remaining_sessions.append(k)
    ...
    def get_next_batch(self, dataset, dataset_session_lengths):
        ...
        for i in range(len(user_list)): user_list[i] = self.users_with_remaining_sessions[user_list[i]]
